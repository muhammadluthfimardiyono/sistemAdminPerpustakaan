...
function EditBuku() {
    ...
    onSubmit: async (values) => {
      ...
      try {
        const bukuBaru = {
          ...
          sumber: sumber,
          kode_rak: kode_rak,
          kode_barcode: bookData.kode_barcode,
        };

        console.log(bukuBaru);
        const response = await axios.put(
          `https://server.libraryselfservice.site/update-buku/${id}`,
          bukuBaru
        );
  ...
  return (
    <div className="mx-5 my-5">
      <SectionHeading title={"Edit Buku"}></SectionHeading>
      <div>
        <div>
