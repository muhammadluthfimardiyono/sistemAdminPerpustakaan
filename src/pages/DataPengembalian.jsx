...
const DataPengembalian = () => {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: `Data Jumlah Transaksi Pengembalian ${new Date().getFullYear()}`,
      },
    },
    animation: {
  ...
  const fetchPeminjaman = async () => {
    try {
      const response = await axios.get(
        "https://server.libraryselfservice.site/pengembalian"
      );
  ...
  return (
    <div>
      <SectionHeading title={"Data Pengembalian"}></SectionHeading>
      ...
      <div>
        <div className="mx-5 my-5">
          ...
          <div className="my-5 flex justify-between">
            <div>
              <h2 className="text-lg font-bold">Cetak Data Pengembalian</h2>
            </div>
            <div className="flex">
              <div className="mx-6">
                <Dropdown label="Bulan Pengembalian" size="sm">
              ...
              <PDFDownloadLink
                ...
                fileName={`Data Transaksi Pengembalian ${selectedMonth} ${thisYear}`}
              >
                {({ loading }) =>
                  loading ? (
          ...
          <Table hoverable={true} className="table-fixed">
            <Table.Head>
              ...
              <Table.HeadCell colSpan={2}>Tanggal Kembali</Table.HeadCell>
                ...
                .map((book, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Table.Cell colSpan={2}>
                        {new Date(book.tanggal_kembali).toLocaleDateString(
                          "id-ID",
                          {
                            weekday: "long",
                            day: "numeric",
